...
export function BrowseFixtures() {
  return (
    <section className="py-24 bg-texture-luxury border-b border-[#E8E4DC] relative overflow-hidden">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {FIXTURE_CARDS.map((card, index) => (
            <Link
              ...
              className={`group relative h-80 rounded-xl overflow-hidden bg-[#141311] border border-[#E8E4DC] transition-all duration-500 hover:shadow-2xl hover:border-[#C9A86B] ${
            ...
            >
              ...
              <div className="absolute inset-0 p-8 flex flex-col justify-between text-white z-10">
                <span className="font-mono text-xs text-[#E5C98B] tracking-widest">
                  {card.count}
                </span>
                ...
                <div>
                  ...
                  <span className="mt-2 inline-flex items-center gap-1 text-xs text-stone-300 group-hover:text-[#E5C98B] font-mono uppercase tracking-wider">
